...
import classes from "./assets/css/landingForm.module.css";
function LandingForm(props) {
	...
	return (
		<div
			...
			className={
				classes.epgcpmForm + " " + classes.form_box + " position-relative"
			}>
			<form id='course-form' method='post' onSubmit={submitHandler}>
				<div className={"form-group chk " + classes.form_group}>
				...
				<button
					id='lead-form-submit-button99'
					className={classes.square_red_btn + " " + classes.apply_btn}>
					Apply Now
				</button>
			</form>
		</div>
